...
* `request_limit_rules` - The request rate limit configuration.  
  The [request_limit_rules](#cdn_configuration_rules_rules_actions_request_limit_rules) structure is documented below.
...
* `error_code_cache` - The error code cache configuration.  
