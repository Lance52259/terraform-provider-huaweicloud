...
* `region` - (Optional, String, ForceNew) Specifies the region in which to create the API environment resource.
  If omitted, the provider-level region will be used.
  Changing this will create a new API environment resource.
...
* `id` - ID of the API environment.
* `create_time` - Time when the API environment was created, in RFC-3339 format.

## Import

API environments can be imported using their `id` and the ID of the APIG instance to which the environment belongs,
