...
* `auth_type` - (Optional, String) Specifies the authentication type.  
  The valid values are as follows:
  + **APP**
  + **IAM**
  + **NONE**
...
* `description` - (Optional, String) Specifies the ID of workspace where the API is located.  
...
* `name` - (Required, String) Specifies the name of the backend paramter.

* `mapping` - (Required, String) Specifies the name of the mapping paramter.
...
* `field` - (Required, String) Specifies the corresponding paramter field for the order parameter.
...
* `example_value` - (Optional, String) Specifies example value of the request parameter.

* `default_value` - (Optional, String) Specifies default value of the request parameter.
...
* `value` - (Optional, String) Specifies the value of the constant parameter.
