...
* `flexible_origin` - (Optional, List) Specifies the flexible origin configuration.
  The [flexible_origin](#cdn_configuration_rule_actions_flexible_origin) structure is documented below.

* `origin_request_header` - (Optional, List) Specifies the origin request header configuration.
  The [origin_request_header](#cdn_configuration_rule_actions_origin_request_header) structure is documented below.

* `http_response_header` - (Optional, List) Specifies the HTTP response header configuration.
...
* `request_limit_rules` - (Optional, List) Specifies the request rate limit configuration.
  The [request_limit_rules](#cdn_configuration_rule_actions_request_limit_rules) structure is documented below.
...
* `error_code_cache` - (Optional, List) Specifies the error code cache configuration.
...
<a name="cdn_configuration_rule_actions_request_limit_rules"></a>
