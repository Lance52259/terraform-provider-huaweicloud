...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_cdn_configuration_share_cache_group"
description: |-
  Manages a share cache group resource within HuaweiCloud.
---

# huaweicloud_cdn_configuration_share_cache_group
...
resource "huaweicloud_cdn_configuration_share_cache_group" "test" {
...
* `group_name` - (Required, String, NonUpdatable) Specifies the name of the share cache group.  
  The valid length is limit from `1` to `128`.
...
* `share_cache_records` - (Required, List) Specifies the list of associated domain names.  
  The [share_cache_records](#cdn_configuration_share_cache_group_share_cache_records) structure is documented below.

<a name="cdn_configuration_share_cache_group_share_cache_records"></a>
...
```bash
$ terraform import huaweicloud_cdn_configuration_share_cache_group.test <id>
```

or

```bash
$ terraform import huaweicloud_cdn_configuration_share_cache_group.test <group_name>
```
