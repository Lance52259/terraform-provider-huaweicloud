		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr(resourceName, "egress"),
					resource.TestCheckNoResourceAttr(resourceName, "ingress"),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckApigInstanceExists(resourceName, &instance),
					resource.TestCheckResourceAttr(resourceName, "name", rName),
					resource.TestCheckResourceAttr(resourceName, "egress.0.bandwidth_size", "3"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckApigInstanceExists(resourceName, &instance),
					resource.TestCheckResourceAttr(resourceName, "name", rName),
					resource.TestCheckResourceAttr(resourceName, "egress.0.bandwidth_size", "5"),
				),
			},
			{
