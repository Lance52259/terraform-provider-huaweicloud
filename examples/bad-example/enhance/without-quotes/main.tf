...
# All rules are tested when instance type and name are missing quotes
...
# ST.010 Error: Missing quotes around both data source type and name
...
# ST.010 Error: Missing quotes around both resource type and name
...
resource huaweicloud_compute_instance test {
 ...
 name               = var.instance_name                                            # ST.005 Error: 2 space instead of 1
  ...
  # ST.007 Error: Missing blank lines between difference naming blocks (1 blank line is expected)
  scheduler_hints {
    group = "group_name"
  }
...
# ST.010 Error: Missing quotes around variable name
...
# ST.010 Error: Missing quotes around output name
output vpc_id {
